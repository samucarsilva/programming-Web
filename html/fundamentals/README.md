...
Um **servidor web** consiste numa subcategoria de servidor de rede — hardware ou software — que gerencia os recursos armazenados em um site, desenhados exclusivamente para processar *requests*:
